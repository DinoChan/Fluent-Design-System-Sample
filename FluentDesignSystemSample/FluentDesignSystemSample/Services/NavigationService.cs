   ...
   public class NavigationService : INavigationService
    {
        ...
        public Task NavigateToDepthAsync() => NavigateToPage<DepthPage>();

        public Task NavigateToLightAsync() => NavigateToPage<LightPage>();

        public Task NavigateToMaterialAsync() => NavigateToPage<MaterialPage>();

        public Task NavigateToMotionAsync() => NavigateToPage<MotionPage>();

        public Task NavigateToScaleAsync() => NavigateToPage<ScalePage>();
